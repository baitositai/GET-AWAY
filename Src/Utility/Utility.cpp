...
std::vector<std::vector<int>> Utility::LoadCSVData(const std::wstring& filePath)
{
...
Vector2 Utility::WorldToMapPos(const Vector2& worldPos, const Vector2& mapSize)
{
...
Vector2 Utility::MapToWorldPos(const Vector2& mapPos, const Vector2& mapSize)
{
...
bool Utility::IsHitCircles(const Vector2& circlePos1, const float radius1, const Vector2& circlePos2, const float radius2)
{
    // 中心点間のX・Y距離を計算
